...
- Разработка и поддержка веб-приложения для разметки трасс на скалодромах
- Разработка CRM для крупного поставщика шин и запчастей
- Разработка веб-приложения, в котором можно находить новых друзей, видеть их на карте, организовывать совместные мероприятия
- Редизайн лендинга (добавление мультиязычности, улучшение семантики и модернизация HTML, SEO-оптимизация, адаптивный дизайн, оптимизация загрузки, повышение производительности)
